...
public class MovieDatabase  {
    ...
    public static void initialize(String moviefile) throws java.io.IOException {
        if (ourMovies == null) {
    ...
    // This method does nothing. It takes an id, gets the id of the movie that has that id and returns it.
